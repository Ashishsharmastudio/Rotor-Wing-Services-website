...
const EmptyLegDirectory = () => {
  const links = [
    ...
    {
      name: "Empty Leg Flights to Atlanta, GA",
      url: "/empty-leg-flights-atlanta-ga",
    },
    {
      name: "Empty Leg Flights to Austin, TX",
      url: "/empty-leg-flights-austin",
    },
    {
      name: "Empty Leg Flights to Beverly Hills",
      url: "/empty-leg-flights-beverly-hills-ca",
    },
    {
      name: "Empty Leg Flights to Boston, MA",
      url: "/empty-leg-flights-boston-ma",
    },
    { name: "Empty Leg Flights to Cancun", url: "/empty-leg-flights-cancun" },
    {
      name: "Empty Leg Flights to Charleston",
      url: "/empty-leg-flights-charleston-sc",
    },
    {
      name: "Empty Leg Flights to Chicago, IL",
      url: "/empty-leg-flights-chicago-il",
    },
    {
      name: "Empty Leg Flights to Dallas, TX",
      url: "/empty-leg-flights-dallas-tx",
    },
    {
      name: "Empty Leg Flights to Denver, CO",
      url: "/empty-leg-flights-denver-co",
    },
    ...
    {
      name: "Empty Leg Flights to Fort Lauderdale",
      url: "/empty-leg-flights-fort-lauderdale",
    },
    { name: "Empty Leg Flights to Hawaii", url: "/empty-leg-flights-hawaii" },
    {
      name: "Empty Leg Flights to Honolulu",
      url: "/empty-leg-flights-honolulu",
    },
    {
      name: "Empty Leg Flights to Houston, TX",
      url: "/empty-leg-flights-houston-tx",
    },
    {
      name: "Empty Leg Flights to Indianapolis",
      url: "/empty-leg-flights-indianapolis",
    },
    {
      name: "Empty Leg Flights to Jacksonville",
      url: "/empty-leg-flights-jacksonville",
    },
    {
      name: "Empty Leg Flights to Kansas City",
      url: "/empty-leg-flights-kansas-city",
    },
    {
      name: "Empty Leg Flights to Las Vegas, NV",
      url: "/empty-leg-flights-las-vegas-nv",
    },
    {
      name: "Empty Leg Flights to Los Angeles, CA",
      url: "/empty-leg-flights-los-angeles-ca",
    },
    {
      name: "Empty Leg Flights to Miami, FL",
      url: "/empty-leg-flights-miami-fl",
    },
    {
      name: "Empty Leg Flights to Naples",
      url: "/empty-leg-flights-naples-fl",
    },
    {
      name: "Empty Leg Flights to Nashville",
      url: "/empty-leg-flights-nashville",
    },
    {
      name: "Empty Leg Flights to New Orleans",
      url: "/empty-leg-flights-new-orleans",
    },
    {
      name: "Empty Leg Flights to New York, NY",
      url: "/empty-leg-flights-new-york-ny",
    },
    { name: "Empty Leg Flights to Ocala, FL", url: "/empty-leg-flights-ocala" },
    {
      name: "Empty Leg Flights to Orlando, FL",
      url: "/empty-leg-flights-orlando",
    },
    {
      name: "Empty Leg Flights to Palm Beach",
      url: "/empty-leg-flights-palm-beach",
    },
    {
      name: "Empty Leg Flights to Philadelphia",
      url: "/empty-leg-flights-philadelphia",
    },
    ...
    {
      name: "Empty Leg Flights to Sacramento",
      url: "/empty-leg-flights-sacramento",
    },
    {
      name: "Empty Leg Flights to Salt Lake City",
      url: "/empty-leg-flights-salt-lake-city",
    },
    {
      name: "Empty Leg Flights to San Diego, CA",
      url: "/empty-leg-flights-san-diego-ca",
    },
    {
      name: "Empty Leg Flights to San Francisco, CA",
      url: "/empty-leg-flights-san-francisco-ca",
    },
    {
      name: "Empty Leg Flights to San Jose",
      url: "/empty-leg-flights-san-jose",
    },
    {
      name: "Empty Leg Flights to Santa Barbara",
      url: "/empty-leg-flights-santa-barbara",
    },
    {
      name: "Empty Leg Flights to Santa Fe",
      url: "/empty-leg-flights-santa-fe",
    },
    {
      name: "Empty Leg Flights to Scottsdale",
      url: "/empty-leg-flights-scottsdale",
    },
    {
      name: "Empty Leg Flights to Seattle, WA",
      url: "/empty-leg-flights-seattle-wa",
    },
    { name: "Empty Leg Flights to Vail", url: "/empty-leg-flights-vail" },
    {
      name: "Empty Leg Flights to Washington, D.C.",
      url: "/empty-leg-flights-washington-dc",
    },
  ];
  ...
  const faqContent = [
    ...
    },
    {
      ...
      answer:
        "You can easily book an empty leg flight through our platform,RWS. We provide an intuitive interface for browsing available flights, and you can book directly through our platform.",
    },
    {
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-10 px-5 md:px-10 xl:px-20 py-7 max-w-[1800px] mx-auto">
      <div className="min-w-full md:min-w-[72%]">
        ...
        />
        <CollapsibleEmptyLegDirectory
          title="The Art of Finding and Booking Empty Leg Flights"
          content={`<p>Our platform,RWS, provides a user-friendly and intuitive interface to effortlessly browse and book empty leg flights. Not only doesRWS give you direct access to these flights, but it also provides the flexibility of booking “near-match” flights that have similar routings, subject to additional positioning fees. <br> <br> For instance, if there’s an empty leg flight listed from New York to Miami, you could utilize this for a trip from New York to Orlando or DC to Palm Beach. It may cost slightly more than a direct match but it’s still a more economical choice compared to booking a round trip.</p>`}
        />
        <CollapsibleEmptyLegDirectory
          title="Pricing Guide: How Much Do Empty Leg Flights Cost? "
      ...
      <Widgets_30Percent_Section
        widgetTitle="Popular Empty Legs Flights"
        widgetContent={[
          {
            name: "Aspen, CO",
