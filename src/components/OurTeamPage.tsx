      ...
      <section className="px-5 md:px-10 lg:px-20 py-7 max-w-[1800px] mx-auto">
        <div className="flex justify-between">
          <div className="w-full max-[650px]:w-full text-center">
            ...
            <p className="text-[#727982] text-md text-center mb-[50px] details">
              AtRWS Aviation, our expert team is devoted to setting the gold
              standard in private jet travel. From your initial inquiry to your
              final destination, each member’s goal is to deliver unparalleled
              safety and personalized service. We distinguish ourselves through
              our boutique approach, pairing industry-leading safety credentials
              with a keen attention to each client’s unique needs. Experience
              for yourself whyRWS is redefining the private jet charter
              industry.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-[32%] rounded-2xl mb-6 max-[700px]:w-full border-[3px] bg-blue-background hover:shadow-card_shadow bg-cover h-[500px] flex flex-col group justify-center items-center gap-x-[15px] p-6  text-white transition-all ease-in duration-100 hover:-translate-y-2 hover:border-blue">
            ...
            />
            <h4 className="text-[20px] font-bold mt-4 mb-4 ">Ricky Gomulka</h4>
            <span className=" mb-5 text-[12px] text-white">
              Founder & Managing Partner
            </span>
            <p className="text-center  text-[15px]">
              Ricky brings extensive industry knowledge and strategic vision
              toRWS Aviation. As a co-founder and managing partner, his
              expertise in private aviation is instrumental in steering the
          ...
          <div className="w-[32%] rounded-2xl mb-6 max-[700px]:w-full border-[3px] bg-blue-background hover:shadow-card_shadow bg-cover h-[500px] flex flex-col group justify-center items-center gap-x-[15px] p-6  text-white transition-all ease-in duration-100 hover:-translate-y-2 hover:border-blue">
            <Image
              ...
              className="w-[160px] h-[160px] rounded-full"
            />
            <h4 className="text-[20px] font-bold mt-4 mb-4 ">Kevin Bales</h4>
            <span className=" mb-5 text-[12px] text-white">Vice President</span>
            <p className="text-center  text-[15px]">
              Kevin's role as Vice President is pivotal in drivingRWS Aviation's
              growth. His leadership and in-depth understanding of the aviation
          ...
          <div className="w-[32%] rounded-2xl mb-6 max-[700px]:w-full border-[3px] bg-blue-background hover:shadow-card_shadow bg-cover h-[500px] flex flex-col group justify-center items-center gap-x-[15px] p-6  text-white transition-all ease-in duration-100 hover:-translate-y-2 hover:border-blue">
            <Image
              ...
              className="w-[160px] h-[160px] rounded-full"
            />
            <h4 className="text-[20px] font-bold mt-4 mb-4 ">Erin Melder</h4>
            <span className=" mb-5 text-[12px] text-white">
              Flight Support & Client Services
            </span>
            <p className="text-center  text-[15px]">
              With 20 years of experience in corporate aviation, Erin, an FAA
              Licensed Aircraft Dispatcher, excels in providing top-notch flight
              support and client services, ensuring safe and efficient
