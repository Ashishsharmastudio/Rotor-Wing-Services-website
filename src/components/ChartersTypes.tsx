      ...
      <div className="flex mt-8 flex-wrap gap-x-[8px] gap-y-[10px]">
        {
          ...
          <div
            key={index}
            className={`${array?.length === 6 ? 'w-[32%] max-[700px]:w-full max-[900px]:w-[48%]': 'w-[14%] max-[900px]:w-[24%] max-[700px]:w-full'} hover:rounded-[19px] h-[270px] border-[3px] transition-all ease-in duration-100 hover:-translate-y-2 hover:border-blue cursor-pointer group bg-cover rounded-2xl relative box-border`}
