        ...
        <section className="bg-black pt-5 px-5 md:px-10 lg:px-20 pb-0">
            <div className=" max-w-[1800px] mx-auto pt-10 text-[#f0f1f2]">
                ...
                {sections.map((section, index) => (
                    <div
                        key={index}
                        className={`bg-[#202020] py-8 border-b border-black lg:flex items-baseline ${index === 0 ? "rounded-[20px_20px_0px_0px]" : ""
            ...
            <div className="relative">
                ...
                <div className="max-w-[1800px] mx-auto flex flex-col lg:flex-row text-[#f0f1f2] gap-5 mt-8 py-4">
                    <div className="flex items-center justify-start gap-3">
                        <a
                            href="https://www.bbb.org/us/fl/orlando/profile/aircraft-brokers/jetlevel-aviation-llc-0733-90714678/#sealclick"
                            id="bbblink"
                            className="ruvtbum max-w-20"
                            target="_blank"
                            rel="nofollow"
                        >
                            <img
                                src="https://seal-centralflorida.bbb.org/logo/ruvtbum/bbb-90714678.png"
                                alt="JetLevel Aviation LLC BBB Business Review"
                                style={{ border: 0 }}
                            />
                        </a>
