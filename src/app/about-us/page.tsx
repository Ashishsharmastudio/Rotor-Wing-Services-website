          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex gap-8 min-[900px]:items-center flex-col lg:flex-row">
              <div className="flex-1">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  ...
                  consultancy, and top-tier manpower solutions. With a
                  deep-rooted passion for aviation excellence, we help
                  operators, MROs, and aviation organizations achieve the
                  highest standards of safety, efficiency, and regulatory
                  compliance.
                </p>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-gray-600">
                  To be the global benchmark for excellence in helicopter
                  training and consultancy, leading the industry towards safer,
                  more efficient operations through quality, expertise, and
